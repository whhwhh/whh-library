					...
					<tr>
						 <td valign="top" bgcolor="#FFFFFF">
							<table width="99%" height="510"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="tableBorder_gray">
								<tr>
									<td height="510" align="left" valign="top" style="padding:5px;">      
										<table width="98%" height="487"  border="0" cellpadding="0" cellspacing="0">
											<tr>
												<td class="word_orange"> &nbsp;&nbsp;当前位置：图书借还 &gt; 图书借阅查询&gt;&gt;&gt; 
												</td>
											</tr>
											<tr>
												<td align="center" valign="top">
													...
													<form name="myform" method="post" action="">
														<table width="723" height="67"  border="0" cellpadding="1" cellspacing="0" bgcolor="#9ECFEE" class="tableBorder_gray">
															<tr>
																...
																<td width="92%" height="29"><input name="flag1" type="checkbox" class="noborder" value="a" checked>请选择查询依据：
																	<select name="flag1" class="wenbenkuang" id="flag1">
																	...
																	<input name="Submit" type="submit" class="btn_grey" value="查询" onClick="return check(myform);">
																</td>
															</tr>
															<tr>
																<td height="26">
																	<input name="flag2" type="checkbox" class="noborder" id="flag2" value="b">借阅时间： 从
													...
													<?php 
														...
														$sql=mysqli_query($conn,"select b.borrowTime,b.backTime,b.ifback,r.barcode as readerbarcode,r.name,k.id,k.barcode,k.bookname from tb_borrow b join tb_reader r on b.readerid=r.id join tb_bookinfo k on b.bookid=k.id");
														//}
														if($_POST!=NULL){
															$flag1=$_POST['flag1'];
															$key1=$_POST['key1'];
															...
															$flag2=$_POST['flag2'];
															if($flag1=="a"){
																$sql=mysqli_query($conn,"select b.borrowTime,b.backTime,b.ifback,r.barcode as readerbarcode,r.name,k.id,k.barcode,k.bookname from tb_borrow b join tb_reader r on b.readerid=r.id join tb_bookinfo k on b.bookid=k.id where $f like '%$key1%'");
															}
															if($flag2=="b"){
																$sql=mysqli_query($conn,"select b.borrowTime,b.backTime,b.ifback,r.barcode as readerbarcode,r.name,k.id,k.barcode,k.bookname from tb_borrow b join tb_reader r on b.readerid=r.id join tb_bookinfo k on b.bookid=k.id where borrowTime between '$sdate' and '$edate'");
															}
															if($flag1=="a" && $flag2=="b"){
																$sql=mysqli_query($conn,"select b.borrowTime,b.backTime,b.ifback,r.barcode as readerbarcode,r.name,k.id,k.barcode,k.bookname from tb_borrow b join tb_reader r on b.readerid=r.id join tb_bookinfo k on b.bookid=k.id where borrowTime between '$sdate' and '$edate' and $f like '%$key1%'");
															}
														}
