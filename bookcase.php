									...
									<tr>
										<td align="center" valign="top">
											<?php
												...
												$sql=mysqli_query($conn,"select * from tb_bookcase order by id desc");      //查询图书书架信息表中的数据信息
												$info=mysqli_fetch_array($sql);      //执行SQL语句
											...
											<table width="100%"  border="0" cellspacing="0" cellpadding="0">
												<tr>
													<td>
														<a href="#" onClick="window.open('bookcase_add.jsp','','width=292,height=175')">添加书架信息</a> 
													</td>
												</tr>
											</table>
											<?php
											...
											<table width="91%"  border="0" cellspacing="0" cellpadding="0">
												<tr>
													...
													<td width="16%" align="right">
														<a href="#" onClick="window.open('bookcase_add.php','','width=292,height=175')">添加书架信息&nbsp;</a>
													</td>	  
												</tr>
											</table>  
											<table width="91%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#D2E3E6" bordercolorlight="#FFFFFF">
												...
												<?php
													}while($info=mysqli_fetch_array($sql));          //do...while循环语句结束
												}
												?>  
											</table>
										</td>
